...
namespace CasoDeEstudio
{
    public class PruebaSistemaNomina
    {
        public static void Main(string[] args)
        {
            ...
            EmpleadoBaseMasComision empleadoBaseMasComision = new EmpleadoBaseMasComision("Bob", "Lewis", "444-44-4444", 5000.00M, .04M, 300.00M);
            ...
            Console.WriteLine("Empleados procesados en forma polimofica:\n");
            ...
            foreach (Empleado empleadoActual in empleados)
            {
                ...
                {
                    //conversion descendete de referencia de Empleado a referencia de EmpleadoBaseMasComision
